...
# Example:
# old location: '/opt/WickrIODebug/clients/calendar_bot/integration/calendar_bot'
# new location: '/opt/WickrIODebug/clients/calendar_bot/integration/calendar_bot.new'
#
...
#
set +e
cp -f processes.json $NEW_BOT_LOCATION
set -e
